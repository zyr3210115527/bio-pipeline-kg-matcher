...
数据层是 2026-08-12 交付的 0812 知识图谱（7,050 individual / 10,178 sample / 26,089 T1 / 36,808 T2），与数据提供方本人的实例逐项一致；落地过程与所有偏离项记录在 [`docs/图谱变更说明_0812_落地记录.md`](docs/图谱变更说明_0812_落地记录.md)。
